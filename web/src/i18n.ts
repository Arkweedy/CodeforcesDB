...
const FULL_TAG_TEXT_ZH: Record<string, string> = {
  ...
  "algorithm/dp/lis-dp": "LIS/非降子序列 DP",
  "algorithm/dp/max-subarray": "最大子段和 DP",
  ...
  "algorithm/transform/fwt/and-fwt": "AND FWT",
