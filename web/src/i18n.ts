...
const FULL_TAG_TEXT_ZH: Record<string, string> = {
  ...
  "algorithm/hashing/2d-rolling-hash": "二维滚动哈希",
  ...
  "algorithm/sqrt-decomposition/mo-algorithm": "莫队",
  "string": "字符串",
  "string/acam": "AC 自动机",
  ...
  "data-structure/frequency-buckets": "频率分块桶",
  ...
  "math/number-theory/base-representation": "进制表示",
  ...
  "trick/oracle-design": "查询设计",
  "trick/median-threshold": "中位数阈值",
  "trick/information-encoding": "信息编码",
