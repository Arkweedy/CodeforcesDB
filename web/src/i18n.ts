...
const FULL_TAG_TEXT_ZH: Record<string, string> = {
  ...
  "dp/pair-dp": "二元组 DP",
  "dp/partition-dp": "分段 DP",
  "dp/profile-dp": "轮廓线 DP",
  ...
  "algorithm/search/binary-search-on-answer": "答案二分",
  ...
  "data-structure/link-cut-tree": "Link-Cut Tree",
  "data-structure/monotonic-queue": "单调队列",
  ...
  "math/combinatorics/reflection-principle": "反射原理",
  ...
  "math/geometry/grid-lines": "格线几何",
  "math/geometry/manhattan-transform": "曼哈顿变换",
  "math/geometry/lattice-points": "格点计数",
  "math/geometry/polygon-inequality": "多边形不等式",
  "math/geometry/projection-metric": "投影度量",
  "math/geometry/reflection-unfolding": "反射展开",
  ...
  "math/number-theory/divisor-enumeration": "因子枚举",
  "math/number-theory/divisor-sieve": "因子筛",
  "math/number-theory/du-sieve": "杜教筛",
  "math/number-theory/euler-phi": "欧拉函数",
  "math/number-theory/gcd": "GCD",
  "math/number-theory/gcd-convolution": "GCD 卷积",
  "math/number-theory/lcm": "LCM",
  "math/number-theory/min25-sieve": "Min_25 筛",
  ...
  "math/order-statistics": "顺序统计",
  "math/order-statistics/median-minimization": "中位数最小化",
  "math/probability": "概率",
  ...
  "special": "特殊题型",
  "trick/scheduling": "调度",
  "trick/scheduling/deadline-greedy": "截止时间贪心",
  "trick": "技巧",
  "trick/alternating-sign-transform": "交替符号变换",
  ...
  "trick/constraint-relaxation": "约束放宽",
  ...
  "trick/dyadic-interval-decomposition": "二进制区间分解",
  "trick/dfs-order-rectangle": "DFS 序矩形化",
  "trick/endpoint-reduction": "端点化简",
  "trick/extreme-position": "极端位置",
  "trick/frontier-maintenance": "前沿维护",
  ...
  "trick/barrier-segmentation": "障碍切段",
  "trick/lexicographic-order": "字典序",
  "trick/maintain-contribution": "维护贡献",
  "trick/mark-multiples": "标记倍数",
  "trick/maximum-count-bound": "最大数量上界",
  "trick/median-alignment": "中位数对齐",
  "trick/monotonicity": "单调性",
  "trick/nearest-occurrence": "最近出现位置",
